...
<!-- 2. nivojski razdelek -->
## Bižnjice na tipkovnici

+ *Kopiraj* označeno v odložišče: Ctrl+C (**C**opy)
+ *Izreži* označeno v odložišče: Ctrl+X
+ *Prilepi* vsebino odložišča: Ctrl+V
+ *Kopiraj* in prilepi v gitbash: Ctrl+Ins in Shift+Ins  Ctrl+Alt+↑↓
+ *Dodaj* kurzor zgoraj/spodaj v VSCode: Ctrl+Alt+↑↓
+ *Odpri* predogled v VSCode: Ctrl+Shift+V
